...
const plans = [
  ...
  },
  {
    name: "Координация",
    price: "15 000 ₽",
    description: "Полное сопровождение в день торжества — с утра и до ухода последнего гостя",
    highlight: false,
  },
  {
  ...
  },
  {
    ...
    price: "от 30 000 ₽",
    description: "Весь путь вашего торжества: от идеи и замысла до яркого завершения вашего праздничного дня",
    highlight: false,
  },
]
